...
class __TwigTemplate_ca8a43f29b21d52ffe7a562bf8e8ece9bbd6d7d47e54f930b4dd3fbfd2a9205f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"w-100\">
      <fieldset>
        <legend>
          ...
          ";
            // line 9
            echo sprintf(_gettext("Users having access to \"%s\""), ((((("<a href=\"" . ($context["database_url"] ?? null)) . PhpMyAdmin\Url::getCommon(["db" => ($context["db"] ?? null)], "&")) . "\">") . twig_escape_filter($this->env, ($context["db"] ?? null), "html")) . "</a>"));
            echo "
        </legend>
...
";
    ...
    {
        return new Source("", "database/privileges/index.twig", "/Applications/MAMP/bin/phpMyAdmin5/templates/database/privileges/index.twig");
    }
}
