...
class __TwigTemplate_d51ea85911836c899f82dd8288d24d63cae8d93850a791f1ebce487a056029d5 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"item\">
    ...
    <input type=\"text\" name=\"username\" id=\"pma_username\" class=\"autofocus\" maxlength=\"";
        ...
        echo "\"";
        // line 12
        if ( !twig_test_empty(($context["g_username"] ?? null))) {
            echo " value=\"";
            echo twig_escape_filter($this->env, (( !(null === ($context["g_new_username"] ?? null))) ? (($context["g_new_username"] ?? null)) : (($context["g_username"] ?? null))), "html", null, true);
            echo "\"";
        }
        // line 13
  ...
  <div class=\"item\">
    ...
    <input type=\"text\" name=\"hostname\" id=\"pma_hostname\" maxlength=\"";
        ...
        echo "\" value=\"";
        echo twig_escape_filter($this->env, ((array_key_exists("g_hostname", $context)) ? (_twig_default_filter(($context["g_hostname"] ?? null), "%")) : ("%")), "html", null, true);
        echo "\" title=\"";
        // line 37
        echo _gettext("Host name");
        echo "\"";
  ...
  <div class=\"item\">
    ...
    <span class=\"options\">
      <select name=\"pred_password\" id=\"select_pred_password\" title=\"";
        ...
        echo ((( !(null === ($context["g_username"] ?? null)) &&  !($context["is_change"] ?? null))) ? (" selected") : (""));
        echo ">";
        echo _gettext("No password");
        echo "</option>
        <option value=\"userdefined\"";
        // line 50
        echo (((null === ($context["g_username"] ?? null))) ? (" selected") : (""));
        echo ">";
        echo _gettext("Use text field");
        echo "</option>
      </select>
    ...
    <input type=\"password\" id=\"text_pma_pw\" name=\"pma_pw\" title=\"";
        ...
        echo _gettext("Password");
        echo "\"";
        echo (((null === ($context["g_username"] ?? null))) ? (" required") : (""));
        echo ">
    <span>";
        // line 54
  ...
  <div class=\"item\" id=\"authentication_plugin_div\">
    ...
    <div id=\"ssl_reqd_warning\"";
      ...
      ";
        ...
        echo "
      ";
        $___internal_329651aadd39d0f8308842482e12a6fb32dabaf99d2a06d3dfb6b03df6203a44_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 82
        echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [$___internal_329651aadd39d0f8308842482e12a6fb32dabaf99d2a06d3dfb6b03df6203a44_]);
        // line 88
        echo "    </div>
  </div>
  ";
...
";
    ...
    {
        return new Source("", "server/privileges/login_information_fields.twig", "/Applications/MAMP/bin/phpMyAdmin5/templates/server/privileges/login_information_fields.twig");
    }
}
